...
Ative os serviços de Authentication (com os provedores "Email/Senha" e "Anônimo") e Firestore Database (em modo de teste).

Registre um novo "App Web" (ícone </>) nas configurações do projeto.

O Firebase fornecerá um objeto de configuração.

Crie um arquivo chamado firebaseConfig.js na raiz do projeto NeuroBalance.

Cole o seguinte código dentro dele, substituindo pelas suas chaves:
